...
public class GuardianBoundaryCustomDisplay : MonoBehaviour
{
    ...
    void RefreshDisplay()
    {
        ...
        {
            case OVRBoundary.BoundaryType.OuterBoundary:
                boundaryPoints = GameObject.Find("/GuardianDebug/Loader").GetComponent<GuardianJsonLoader>().OuterBoundaryPositions.ToArray();
                break;

            case OVRBoundary.BoundaryType.PlayArea:
                boundaryPoints = GameObject.Find("/GuardianDebug/Loader").GetComponent<GuardianJsonLoader>().PlayAreaPositions.ToArray();
                break;
            default:
                return;
        }
